                      ...
                      <el-header style="font-size: 12px;">
                          ...
                          <el-dialog title="增加算子" :visible.sync="addUserOpDialogVisible" width="25%" center>
                              ...
                              <span slot="footer" class="dialog-footer">
                                  ...
                                  <el-button @click="addUserOpDialogVisible = false; selectedAddOperators=[];">取消
                                  </el-button>
                              </span>
                          </el-dialog>
                          <!-- 导入体系树，xml文件 -->
                              ...
                              <div style="height: 250px; overflow: auto">
                                  <el-form ref="form" :model="changeUserForm" label-width="80px" :rules="userRule">
                                      ...
                                      <el-form-item label="邮箱地址" prop="email">
                                          <el-input v-model="changeUserForm.email"><template
              ...
              methods: {
                  ...
                  switchPage(index) {
                      ...
                      if (index == '1-1') { //所有的体系模板
                          ...
                          this.schemeIDForResult = '';
                          this.execTimeForResult = '';
                  ...
                  getResult() {
                      ...
                      axios({
                          method: 'get',
                          url: _this.urlHeader + 'request=getResult&scheme_id=' + _this
                              .schemeIDForResult + '&exec_time=' + _this.execTimeForResult
                      }).then(function (resp) {
                  ...
                  getAllResultTimeOfScheme() {
                      ...
                      axios({
                          method: 'get',
                          url: _this.urlHeader + 'request=getAllResultTime&scheme_id=' + _this
                              .schemeIDForResult
                      }).then(function (resp) {
                          console.log('获取到了所有时间信息:\n' + resp.data);
                  ...
                  deleteOperators() {
                      if (this.multipleSelection.length == 0) { //若是没有选中任何算子
                          ...
                          Vue.prototype.$confirm('此操作将删除所选算子，是否删除？', '提示', {
                              ...
                              //删除用户所选的算子
                              var _this = this;
                              var data = "user_id=" + this.currentUser.user_id + "&selectedDelOps=" +
                                  JSON
                  ...
                  getSchemeInfo(isInstance) {
                      ...
                      axios({
                          method: 'get',
                          url: _this.urlHeader + 'request=SchemeInfoForDisplay&user_id=' + this
                              .currentUser
                  ...
                  //修改信息
                  changeInfo(param) {
                      if (this.changeUserForm.username == '' || this.changeUserForm.password == '' || this
                  ...
                  fuzzyQueryBySchemeName() {
                      ...
                      axios({
                          method: "post",
                          url: url,
                          data: "scheme_name=" + _this.schemeNameForQuery + '&user_id=' + _this
                              .currentUser
                              .user_id +
                  ...
                  addOrChangeIndice() {
                      ...
                      if (this.innerDrawerTitle == '新增指标') {
                          if (typeof (_this.indiceForm.father_id) == 'undefined' || _this.indiceForm
                              .father_id == '') {
                  ...
                  displaySchemeByTree(row) {
                      console.log('展示体系树');
                      var isInstance = this.pageNo == '1-1' ? 0 : 1;
                      window.location.href = "http://localhost:2008/SEClassDesign/getSystemTree.do?scheme_id=" +
                          row
